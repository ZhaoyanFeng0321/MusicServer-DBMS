...
public class SectionOrmDao {
    ...
    @PostMapping("/orm/sections")
    public Section createSection(@RequestBody Section section) {
        return sectionRepository.save(section);
    }

    @PostMapping("/orm/courses/{courseId}/sections")
    ...
    @GetMapping("/orm/courses/{cid}/sections")
    ...
    @GetMapping("/orm/sections")
    public List<Section> findAllSections() {
        return (List<Section>) sectionRepository.findAll();
    }
    
    @GetMapping("/orm/sections/{sectionId}")
    public Section findSectionById(
            @PathVariable("sectionId") Integer id) {
        return sectionRepository.findById(id).get();
    }

    @PutMapping("/orm/sections/{sectionId}")
...
//        section.setStartDate(newSection.getStartDate());
    ...
    @DeleteMapping("/orm/sections/{sectionId}")
